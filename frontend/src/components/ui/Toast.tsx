...
const Toast: React.FC<ToastProps> = ({ id, type, message, duration = 5000, onClose }) => {
  ...
  const typeStyles = {
    ...
    warning: 'text-emerald-800 text-emerald-800 text-emerald-800 dark:text-emerald-800 dark:text-emerald-800',
    info: 'text-emerald-800 text-emerald-800 text-emerald-800 dark:text-emerald-800 dark:text-emerald-800',
  };
