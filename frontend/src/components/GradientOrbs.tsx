...
const GradientOrbs: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      <div className="absolute left-[-8%] top-[-12%] h-[22rem] w-[22rem] rounded-full bg-[radial-gradient(circle,rgba(91,63,214,0.28)_0%,rgba(91,63,214,0.08)_38%,transparent_70%)] blur-3xl parallax-slow" />
      <div className="absolute right-[-10%] top-[8%] h-[20rem] w-[20rem] rounded-full bg-[radial-gradient(circle,rgba(244,114,182,0.22)_0%,rgba(244,114,182,0.07)_38%,transparent_68%)] blur-3xl parallax-medium" />
