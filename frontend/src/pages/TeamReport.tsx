  ...
  if (!isManagerOrLead) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white">Team Report</h1>
        </div>
    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid gap-4 md:grid-cols-4">
          <Card className="p-6">
            <div className="text-sm font-medium text-white/50">Total Meetings</div>
          ...
          <Card className="p-6">
            <div className="text-sm font-medium text-white/50">Total Team Members</div>
            <div className="text-3xl font-bold text-white mt-2">
              {teamMembers.length}
            </div>
            <p className="text-xs text-white/40 mt-2">
          ...
          <Card className="p-6">
            <div className="text-sm font-medium text-white/50">Avg Meeting Duration</div>
            <div className="text-3xl font-bold text-white mt-2">
              {stats.avgDuration}m
            </div>
            <p className="text-xs text-white/40 mt-2">
            ...
            {stats.topParticipants.map((participant, index) => (
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-white/[0.06] text-cyan-300 flex items-center justify-center text-sm font-bold text-cyan-300">
                    {index + 1}
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {member.recentTasks.map((task) => (
                        <div
                          key={task.id}
                          className="flex items-center justify-between p-2 bg-white/[0.03] border border-white/10 rounded"
                        >
