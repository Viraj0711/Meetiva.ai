...
const Analytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Empty State Banner */}
      {hasNoData && (
        <Card className="p-6 text-cyan-300 dark:text-cyan-300">
          <div className="flex items-start gap-3">
            <svg className="w-5 h-5 text-cyan-300 dark:text-cyan-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button variant="outline" className="hover:bg-cyan-300 hover:text-white hover:border-cyan-300">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-white/60">Avg. Meeting Duration</h3>
            <div className="w-10 h-10 text-cyan-300 dark:text-cyan-300 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-cyan-300 dark:text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
          </div>
          <p className="text-3xl font-bold">{analytics.productivityMetrics.avgMeetingDuration} min</p>
          <p className="text-sm text-cyan-300 mt-2">? 5% from last period</p>
        </Card>

        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-white/60">Tasks per Meeting</h3>
          ...
          <p className="text-sm text-cyan-300 mt-2">? 12% from last period</p>
        </Card>

        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-white/60">Completion Rate</h3>
            <div className="w-10 h-10 bg-white/[0.04] rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-cyan-300 dark:text-cyan-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
          </div>
          <p className="text-3xl font-bold">{analytics.productivityMetrics.completionRate}%</p>
          <p className="text-sm text-cyan-300 mt-2">? 8% from last period</p>
        </Card>

        <Card className="p-6 md:col-span-3 lg:col-span-1">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-white/60">Team Follow-ups (7d)</h3>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {/* Meeting Trends */}
        <Card className="p-6">
          <h2 className="text-xl font-bold text-white mb-6">Meeting Trends</h2>
          {analytics.meetingTrends.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-white font-medium">No meeting data yet</p>
              <p className="text-sm text-white/60">Upload meetings to see trends</p>
            </div>
          ) : (
              ...
              {analytics.meetingTrends.map((trend, index) => (
                <div key={index}>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="text-white/60">{trend.count} meetings</span>
                  </div>
        ...
        <Card className="p-6">
          <h2 className="text-xl font-bold text-white mb-6">Action Item Distribution</h2>
          <div className="space-y-6">
      ...
      {/* Top Participants */}
      <Card className="p-6">          <h2 className="text-xl font-bold text-white mb-6">Top Participants</h2>
        {analytics.topParticipants.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-white font-medium">No participants yet</p>
            <p className="text-sm text-white/60">Upload meetings to see top participants</p>
          </div>
        ) : (
          <div className="space-y-4">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-white">Team Follow-up Activity</h2>
        ...
        {analytics.teamFollowUpChat.dailyTrend.length === 0 && analytics.teamFollowUpChat.teamStats.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-10 text-center">
            ...
            <p className="font-medium text-white">No follow-up activity yet</p>
            <p className="text-sm text-white/60">Use team chat to track project follow-ups.</p>
          </div>
        ) : (
          <div className="grid gap-6 lg:grid-cols-2">
            <div>
      ...
      {/* Insights */}
      {!hasNoData && (
        <Card className="p-6 bg-gradient-to-br from-purple-900/20 text-cyan-300">
          ...
          <div className="flex items-start">
            <div className="w-8 h-8 rounded-lg text-cyan-300 flex items-center justify-center mr-3 flex-shrink-0">
